...
/**
 * Attribute Name: CW-Clg-Party-E164-Type<br>
 ...
 */
public final class Attr_CWClgPartyE164Type extends VSAttribute
{
    public static final String NAME = "CW-Clg-Party-E164-Type";
    public static final int VENDOR_ID = 429;
    public static final int VSA_TYPE = 0x800c;
    ...
    public Attr_CWClgPartyE164Type()
    {
        setup();
    }

    public Attr_CWClgPartyE164Type(Serializable o)
    {
        setup(o);
    }
}
