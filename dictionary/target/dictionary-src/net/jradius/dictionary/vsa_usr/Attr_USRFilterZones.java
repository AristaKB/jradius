...
/**
 * Attribute Name: USR-Filter-Zones<br>
 ...
 */
public final class Attr_USRFilterZones extends VSAttribute
{
    public static final String NAME = "USR-Filter-Zones";
    public static final int VENDOR_ID = 429;
    public static final int VSA_TYPE = 0x980e;
    ...
    public Attr_USRFilterZones()
    {
        setup();
    }

    public Attr_USRFilterZones(Serializable o)
    {
        setup(o);
    }
}
