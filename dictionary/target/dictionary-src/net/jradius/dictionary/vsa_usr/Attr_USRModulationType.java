...
/**
 * Attribute Name: USR-Modulation-Type<br>
...
public final class Attr_USRModulationType extends VSAttribute
{
    ...
    public static final int VSA_TYPE = 0x006C;
    ...
    public static final Long v90Analog = new Long(33L);
    ...
    protected class NamedValueMap implements NamedValue.NamedValueMap, Serializable
    {
        ...
        public Long getNamedValue(String name)
        {
            ...
            if ("v90Analog".equals(name)) return new Long(33L);
        ...
        public String getNamedValue(Long value)
        {
            ...
            if (new Long(33L).equals(value)) return "v90Analog";
    ...
    public Attr_USRModulationType(Serializable o)
    {
        setup(o);
    }
}
