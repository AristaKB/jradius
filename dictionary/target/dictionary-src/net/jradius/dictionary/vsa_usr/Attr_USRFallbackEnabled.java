...
/**
 * Attribute Name: USR-Fallback-Enabled<br>
 ...
 */
public final class Attr_USRFallbackEnabled extends VSAttribute
{
    public static final String NAME = "USR-Fallback-Enabled";
    public static final int VENDOR_ID = 429;
    public static final int VSA_TYPE = 0x0070;
    ...
    public Attr_USRFallbackEnabled()
    {
        setup();
    }

    public Attr_USRFallbackEnabled(Serializable o)
    {
        setup(o);
    }
}
