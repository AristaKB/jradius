...
/**
 * Attribute Name: Ascend-Token-Immediate<br>
 ...
 */
public final class Attr_AscendTokenImmediate extends VSAttribute
{
    public static final String NAME = "Ascend-Token-Immediate";
    ...
    public Attr_AscendTokenImmediate()
    {
        setup();
    }

    public Attr_AscendTokenImmediate(Serializable o)
    {
        setup(o);
    }
}
