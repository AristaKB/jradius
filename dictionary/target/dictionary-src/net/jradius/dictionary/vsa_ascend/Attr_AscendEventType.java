...
/**
 * Attribute Name: Ascend-Event-Type<br>
 ...
 */
public final class Attr_AscendEventType extends VSAttribute
{
    public static final String NAME = "Ascend-Event-Type";
    ...
    public Attr_AscendEventType()
    {
        setup();
    }

    public Attr_AscendEventType(Serializable o)
    {
        setup(o);
    }
}
