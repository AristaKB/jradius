...
/**
 * Attribute Name: ERX-Cli-Allow-All-VR-Access<br>
 ...
 */
public final class Attr_ERXCliAllowAllVRAccess extends VSAttribute
{
    public static final String NAME = "ERX-Cli-Allow-All-VR-Access";
    ...
    public Attr_ERXCliAllowAllVRAccess()
    {
        setup();
    }

    public Attr_ERXCliAllowAllVRAccess(Serializable o)
    {
        setup(o);
    }
}
