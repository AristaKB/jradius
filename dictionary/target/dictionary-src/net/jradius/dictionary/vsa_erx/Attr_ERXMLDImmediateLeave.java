...
/**
 * Attribute Name: ERX-MLD-Immediate-Leave<br>
 ...
 */
public final class Attr_ERXMLDImmediateLeave extends VSAttribute
{
    public static final String NAME = "ERX-MLD-Immediate-Leave";
    ...
    public Attr_ERXMLDImmediateLeave()
    {
        setup();
    }

    public Attr_ERXMLDImmediateLeave(Serializable o)
    {
        setup(o);
    }
}
