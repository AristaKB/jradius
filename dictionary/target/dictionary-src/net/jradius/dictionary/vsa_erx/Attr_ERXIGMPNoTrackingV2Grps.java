...
/**
 * Attribute Name: ERX-IGMP-No-Tracking-V2-Grps<br>
 ...
 */
public final class Attr_ERXIGMPNoTrackingV2Grps extends VSAttribute
{
    public static final String NAME = "ERX-IGMP-No-Tracking-V2-Grps";
    ...
    public Attr_ERXIGMPNoTrackingV2Grps()
    {
        setup();
    }

    public Attr_ERXIGMPNoTrackingV2Grps(Serializable o)
    {
        setup(o);
    }
}
