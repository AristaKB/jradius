...
/**
 * Attribute Name: ERX-MLD-No-Tracking-V1-Grps<br>
 ...
 */
public final class Attr_ERXMLDNoTrackingV1Grps extends VSAttribute
{
    public static final String NAME = "ERX-MLD-No-Tracking-V1-Grps";
    ...
    public Attr_ERXMLDNoTrackingV1Grps()
    {
        setup();
    }

    public Attr_ERXMLDNoTrackingV1Grps(Serializable o)
    {
        setup(o);
    }
}
