...
/**
 * Attribute Name: WiMAX-vDHCPv6-Server<br>
 ...
 */
public final class Attr_WiMAXvDHCPv6Server extends VSAttribute
{
    public static final String NAME = "WiMAX-vDHCPv6-Server";
    ...
    public Attr_WiMAXvDHCPv6Server()
    {
        setup();
    }

    public Attr_WiMAXvDHCPv6Server(Serializable o)
    {
        setup(o);
    }
}
