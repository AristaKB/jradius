 ...
 */
public final class Attr_WiMAXPPAC extends VSAWithSubAttributes
{
    public static final String NAME = "WiMAX-PPAC";
    ...
    public Attr_WiMAXPPAC()
    {
        setup();
    }

    public Attr_WiMAXPPAC(Serializable o)
    {
        setup(o);
    }
}
